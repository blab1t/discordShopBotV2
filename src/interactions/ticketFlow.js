...
const PANEL_TICKETS = {
  buy: {
    baseName: 'buy',
    categoryKey: 'buy',
    welcome: 'Tell us which account you want to buy and how you want to pay. Staff will be with you shortly.',
  },
  other: {
    baseName: 'support',
    categoryKey: 'support',
...
async function handle(interaction, parts) {
  ...
  if (ns === 'cl') {
    ...
    // `/close keep-proxy:true` was stored when the request was made.
